...
# Available Paths
    def get_paths(self, src, dst):
        ...
        print("=== Running Singlepath DFS algorithm ===")
        print("Iterasi : ", i)
        #print("All paths from sw ", src, " to sw ", dst)
        paths.sort(key=len)
        #print("sorted paths by length from sw ", src, " to sw ", dst)
...
# Installing paths        
    def install_paths(self, src, first_port, dst, last_port, ip_src, ip_dst):
        ...
        with open('./data_export/shortest_dfs.csv', 'a+', newline='') as f:
